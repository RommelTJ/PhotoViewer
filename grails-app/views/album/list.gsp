                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="album.pictures.label" default="Pictures" /></th>
                    ...
                    <g:each in="${albumInstanceList}" status="i" var="albumInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: albumInstance, field: "caption")}</td>
                        
                            <td>${fieldValue(bean: albumInstance, field: "description")}</td>
                        
                            <td>${fieldValue(bean: albumInstance, field: "pictures")}</td>

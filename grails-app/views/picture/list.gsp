                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="picture.images.label" default="Images" /></th>
                   	    
                            <th><g:message code="picture.user.label" default="User" /></th>
                    ...
                    <g:each in="${pictureInstanceList}" status="i" var="pictureInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: pictureInstance, field: "images")}</td>
                        
                            <td>${fieldValue(bean: pictureInstance, field: "user")}</td>
